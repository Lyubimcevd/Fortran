   ...
   30 FORMAT(/,2X,'ÈTOÃO ÏO ÈÏ  ',T40,F8.1,T50,F8.1,T60,F7.1,T70,F7.1,  15090010
     1T80,F7.1,T90,F7.1,T100,F7.1,T110,F7.1,T120,F8.1)                  15090011
    1 FORMAT(/,/,/,/T114,'ËÈCT',I3)                                     15090012
    2 FORMAT(T41,'ÈHBEHTAPÈÇAÖÈOHHAß BEÄOMOCTÜ ÏO ÈHÑÒÐ.ÏÐÎÈÇÂÎÄÑÒÂÓ')  15090013
   ...
   82 FORMAT(1X,' ÈTOÃO',T50,F8.1,T81,F8.1,'   BCEÃO ÇAKAÇOB: ',I5)     15090026
      open(4,file='F:\ASUIPW\tek_INF\invzaks.dat')
      open(1,file='prn')
